...
function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Kategori:</td><td> '+ aData[5] +' </td></tr>';
    sOut += '<tr><td>Ürün Ekle:</td><td> <a title = "Ürün Ekle" href = "/Admin/Product/AddProduct" class = "btn btn-primary" > Ürün Ekle </a> </td></tr>';
    sOut += '</table>';
